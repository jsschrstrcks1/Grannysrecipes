...
```bash
python3 /home/user/.memory/memory_ops.py recall "" --scope /recipes/granny --limit 10
python3 /home/user/.memory/memory_ops.py tree /recipes/granny
```
...
```bash
python3 /home/user/.memory/memory_ops.py recall "QUERY" --scope /recipes/granny
```
...
```bash
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/granny --older-than 90 --dry-run
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/granny --older-than 90
```
